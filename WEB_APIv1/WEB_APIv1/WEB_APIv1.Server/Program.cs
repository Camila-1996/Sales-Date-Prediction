...
using WEB_APIv1.Server.Authorization;
using WEB_APIv1.Server.Authorization.Requirements;
using WEB_APIv1.Server.Configuration;
...
app.UseSwaggerUI(c =>
{
    c.DocumentTitle = "Swagger UI - WEB_APIv1";
